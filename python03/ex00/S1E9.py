...
class Character(ABC):
    """
    docstr [Character]
    An abstract class, which has abstract method for constructor, and die
    method need children class to be instanstiated.
    """
...
class Stark(Character):
    """
    docstr [Stark]
    A class inherent from abstract character class, has its own
    __init__ method and die method inherent from parent.
    """

    def __init__(self, first_name, is_alive=True):
        """
        docstr [Stark init]
        Inherent from character class, it takes _name, and optional is_alive,
